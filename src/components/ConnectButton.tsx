...
export default function ConnectButton({ fullWidth = false }: { fullWidth?: boolean }) {
  ...
  const base = `bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-black font-semibold transition-colors cursor-pointer${fullWidth ? ' w-full py-3 rounded-xl text-[14px]' : ' text-[13.5px] px-5 py-1.5 rounded-full whitespace-nowrap'}`;
